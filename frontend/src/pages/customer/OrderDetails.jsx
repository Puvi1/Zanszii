          ...
          return (
            <div key={step} className="text-center">
              <div className="relative flex items-center">
                ...
                <span
                  className={`relative z-10 mx-auto grid h-10 w-10 place-items-center rounded-full border-2 ${
                    complete
              ...
              <p
                className={`mt-2 text-xs font-black ${
                  complete ? "text-[#0F4C9C]" : "text-slate-400"
                }`}
              >
                {LABELS[step]}
              </p>
      ...
      <section className="overflow-hidden rounded-[30px] bg-gradient-to-r from-[#062B5F] to-[#0F4C9C] p-6 text-white shadow-xl sm:p-8">
        <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="rounded-2xl bg-white/10 px-5 py-4 backdrop-blur">
            <p className="text-xs font-bold text-blue-100">Order total</p>
          ...
          <div className="mt-6 space-y-3 border-t border-slate-100 pt-5">
            {order.status_history
              ...
              .map((entry, index) => (
                ...
                >
                  <span className="mt-1 h-2.5 w-2.5 shrink-0 rounded-full bg-[#0F4C9C]" />
            ...
            <section className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
              ...
              {order.delivery_partner_phone && (
                <a
                  ...
                  className="mt-4 inline-flex items-center gap-2 text-sm font-black text-[#0F4C9C]"
                >
                  <Phone size={17} />
                  {order.delivery_partner_phone}
                </a>
