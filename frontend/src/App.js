...
export default function App() {
 return <BrowserRouter><AuthProvider><Routes>
   ...
   <Route element={<ProtectedRoute roles={["admin"]}/> }><Route element={<AppLayout/>}><Route path="/admin" element={<AdminDashboard/>}/><Route path="/admin/products" element={<AdminProducts/>}/><Route path="/admin/categories" element={<AdminCategories/>}/><Route path="/admin/orders" element={<ComingSoon title="Manage Orders"/>}/><Route path="/admin/customers" element={<ComingSoon title="Customers"/>}/><Route path="/admin/managers" element={<ComingSoon title="Managers"/>}/><Route path="/admin/reports" element={<AdminReports/>}/></Route></Route>
